...
coverpkg="github.com/medisco/opgeth/..."
...
repo=$GOPATH/src/github.com/medisco/opgeth
compile_fuzzer github.com/medisco/opgeth/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/medisco/opgeth/common/bitutil \
...
compile_fuzzer github.com/medisco/opgeth/eth/protocols/snap \
...
compile_fuzzer github.com/medisco/opgeth/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/medisco/opgeth/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/medisco/opgeth/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/medisco/opgeth/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
  $repo/tests/fuzzers/secp256k1/secp_test.go

compile_fuzzer github.com/medisco/opgeth/eth/protocols/eth \
